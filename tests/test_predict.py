...
This test is robust to different CI working-directory setups: it ensures
the repository root is on sys.path before importing the application module.
"""
...
# Ensure the repository root is on sys.path so `from app import app` works
...
def test_predict_endpoint():
    """Start the app and POST the sample payload; assert 200 and expected keys."""
